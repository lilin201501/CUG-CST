...
void system_display::initialization()
{
    ...
    case 3:{
        ...
        this->model->setHorizontalHeaderItem(2,new QStandardItem("开设学院"));
        this->model->setHorizontalHeaderItem(3,new QStandardItem("学分"));
        this->model->setHorizontalHeaderItem(4,new QStandardItem("课时"));
        ...
        this->ui->tableView->setColumnWidth(2,240);
...
void system_display::calculation()
{
    ;
}
